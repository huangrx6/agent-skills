...
ROLES: dict[str, dict] = {
    ...
    "breakdown": {"label":  "目录 / 结构拆解", "visual": ('none',), "types": ("content-text", "two-column"),
                  "when": "把后面要讲的东西列成几块"},
    "evidence": {"label":  "证据 / 细节", "visual": ('none', 'evidence_image'), "types": ("content-text", "content-image"),
    ...
    "composition": {"label":  "构成 / 占比", "visual": ('data',), "types": ("chart",),
                    "when": "构成与份额"},
    "comparison": {"label":  "对比", "visual": ('none', 'data', 'evidence_image'), "types": ("two-column", "chart", "content-image"),
                   "when": "两边对照；两栏、对比图或文图"},
    "process": {"label":  "流程 / 路径", "visual": ('none', 'evidence_image'), "types": ("timeline", "content-image"),
                "when": "有几步、有先后"},
    "capabilities": {"label":  "能力并列", "visual": ('none',), "types": ("two-column", "content-text"),
                     "when": "几项对等的能力/模块"},
    "architecture": {"label":  "分层架构", "visual": ('evidence_image',), "types": ("content-image",),
                     "when": "层与层的关系；结构图（excalidraw / draw.io）"},
    "flow": {"label":  "流程 / 拓扑图", "visual": ('evidence_image',), "types": ("content-image",),
             "when": "节点与连线；结构图"},
    "topology": {"label":  "拓扑 / 关系", "visual": ('evidence_image',), "types": ("content-image",),
                 "when": "多节点的连接关系；结构图"},
    "hero_visual": {"label":  "大图主角", "visual": ('evidence_image',), "types": ("content-image",),
                    "when": "一张图承担这一页的主要信息"},
    "context_image": {"label":  "配图 / 场景", "visual": ('evidence_image',), "types": ("content-image",),
                      "when": "图说明背景，文字仍是主角"},
    ...
    "observation": {"label":  "观点 / 展望", "visual": ('none',), "types": ("content-text", "two-column"),
                    "when": "判断与看法"},
    "team": {"label":  "团队 / 关于", "visual": ('evidence_image', 'none'), "types": ("content-image", "content-text"),
             "when": "谁在做"},
